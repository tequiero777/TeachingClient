package com.tianjian.teachingclient.util.network.helper;
...
/*	private static final String keyStoreFileName = "client.key.p12";
	...
	public static SSLSocketFactory getSSLSocketFactory ()
		...
		try{
			KeyManager[] keyManagers = createKeyManagers(Constant.KEY_STORE_PASSWORD, alias);
			TrustManager[] trustManagers = createTrustManagers(Constant.KEY_STORE_TRUST_PASSWORD);
	...
	private static KeyManager[] createKeyManagers(String keyStorePassword, String alias)
			throws CertificateException, IOException, KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
		

		InputStream inputStream = TwoWaysAuthenticationSSLSocketFactory.class.getClassLoader().getResourceAsStream(Constant.KEY_STORE_CLIENT_PATH);
	...
	private static TrustManager[] createTrustManagers(String trustStorePassword)
			throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException {
		
		InputStream inputStream = TwoWaysAuthenticationSSLSocketFactory.class.getClassLoader().getResourceAsStream(Constant.KEY_STORE_TRUST_PATH);
