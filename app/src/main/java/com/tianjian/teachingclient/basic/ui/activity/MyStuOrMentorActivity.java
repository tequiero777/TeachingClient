...
import com.tianjian.teachingclient.basic.ui.adapter.MyStudentOrMentorAdapter;
...
public class MyStuOrMentorActivity extends BaseActivity{
	...
	private void queryData(HashMap<String, Object> hashMap) {
		final CustomerProgress customerProgress =  new CustomerProgress(MyStuOrMentorActivity.this,com.tianjian.teachingclient.R.style.customer_dialog);
