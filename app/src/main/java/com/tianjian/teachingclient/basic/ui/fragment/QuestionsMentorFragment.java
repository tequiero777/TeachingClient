...
import com.tianjian.teachingclient.basic.bean.ClassBean;
import com.tianjian.teachingclient.basic.ui.adapter.TabsAdapter;
import com.tianjian.teachingclient.basic.ui.fragment.QuestionsStudentFragment.MyOnClickListener;
...
public class QuestionsMentorFragment extends BaseFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(rootView == null){
			...
			titleListview = (LinearLayout) rootView.findViewById(R.id.question_men_tab_title);	      
			getScreenSize();
	...
	private void initView() {
		...
		cb1.setClassName("提问我的");
		ClassBean cb2 = new ClassBean();
		cb2.setClassName("公开提问");
		tabsList.add(cb1);
		tabsList.add(cb2);
		
		AskMeQuestionFragment viewPagerFragment1 = new AskMeQuestionFragment();		
