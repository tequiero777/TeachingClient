...
import com.tianjian.teachingclient.basic.ui.adapter.ChooseStuAdapter;
...
//				setResult(2,  getIntent().putExtra("list", gson.toJson(selected_templist)));
	...
	private void queryData(HashMap<String, Object> hashMap) {
		final CustomerProgress customerProgress =  new CustomerProgress(ChooseStuActivity.this,com.tianjian.teachingclient.R.style.customer_dialog);
