...
import com.tianjian.teachingclient.basic.bean.ImPortInformationSrv.ImPortInformationSrvResponse;
...
import com.tianjian.teachingclient.basic.bean.InTeachManagerSrv.InTeachManagerSrvResponse;
		...
		button_save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(!content_text.getText().toString().equals("")){
					customerProgress =  new CustomerProgress(ContactAdminActivity.this,com.tianjian.teachingclient.R.style.customer_dialog);
