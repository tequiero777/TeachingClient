 ...
 */
package com.tianjian.teachingclient.basic.ui.view;
 ...
 * 上下拉刷新
 * <p>
 * Title: PullRefreshListView.java
 * </p>
 * <p>
...
public class PullRefreshListView extends ListView implements OnScrollListener {
	...
	// 区分当前操作是刷新还是加载
		...
		private void initView(Context context) {
			...
			footerPadding(-headerContentHeight);
		...
		private void footerPadding(int footerPadding){
			footer.setPadding(header.getPaddingLeft(), footer.getPaddingTop(),
					footer.getPaddingRight(), footerPadding);
			footer.invalidate();
		}
		/**
