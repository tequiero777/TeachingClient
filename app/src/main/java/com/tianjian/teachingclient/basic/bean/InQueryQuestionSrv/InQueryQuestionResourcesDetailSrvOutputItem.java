...
package com.tianjian.teachingclient.basic.bean.InQueryQuestionSrv;


/**
 * <p>InQueryQuestionResourcesDetailSrvOutputItem complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="InQueryQuestionResourcesDetailSrvOutputItem">
 *   &lt;complexContent>
 ...
 * 
 */
public class InQueryQuestionResourcesDetailSrvOutputItem {
